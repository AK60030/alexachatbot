...
<div id="main-wrapper">
	...
	<form class="myform" action="register.php" method="post" enctype="multipart/form-data">
		<div class="inner_container">
			...
			<input name="cpassword" type="password" id="rcpass" class="inputvalues" placeholder="Confirm password" /><br>
			<input name="image" type="file" id="image" class="file" required><br>
